...
import artistProfile from '../../assets/img/artist-profile.png';
import faleComigo from '../../assets/img/fale-comigo.jpg';
    ...
    return (
        <div className={style.about}>
            ...
            <div className={style.artist}>
                ...
                <img src={artistProfile} alt="Foto Artista - Anna Júlia" className={classImg}></img>              
            </div>  
        </div>
    )
}